...
export default function Navi() {
  ...
  const path= location.pathname   //importing path here
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
           React and Python/Django web application
          </Typography>
        </Toolbar>
      </AppBar>
      <Drawer
      ...
      >
        ...
        <List>
            ...
            <ListItem  disablePadding>
              <ListItemButton component = "a" href="/video.html">  
              <ListItemIcon>
              <FeaturedVideoIcon/>
              </ListItemIcon>
        ...
        <Divider />
        <List>
          {['Addrec', 'deleterec', 'updaterec'].map((text, index) => (
